...
Guidelines:
- Tone: engaging, conversational, and educational — suitable for narration with GTTS.
...
- In construct(), use: self.set_speech_service(GTTSService(lang="en", tld="com", transcription_model="base"))
