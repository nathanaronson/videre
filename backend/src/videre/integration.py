# WRITTEN BY KAITLYN KWAN ON 2025-11-08
# RIP LASTED 5 HOURS UNTIL KAITLYN GOT UPSET AT NATHAN FOR 
# APPARENTLY STEALING HER JOB EVEN THOUGH HE DIDNT AND THE
# THING HE MADE WAS 10 TIMES WORSE THAN HERS AND SHE REFUSED
# TO LISTEN TO HIM BECAUSE SHE WAS SO MAD AND JUST IGNORED HIM
# AND THEN HE GOT SAD BECAUSE HE REALIZED THAT HER CODE WAS
# ACTUALLY BETTER EXCEPT SHE JUST DIDNT CARE ANYMORE BECAUSE
# SHE WAS PROBABLY ACTUALLY JUST WANTING TO FIND A REASON TO
# BE MAD AT HIM TO BEGIN WITH BECAUSE HE MOGGED HER THE NIGHT
# BEFORE BY BEING ABLE TO STAY OUTSIDE FOR A LONGER AMOUNT OF
# TIME THAN HER EVEN THOUGH SHE LIES ABOUT THIS TO DATE AND
# SAYS SHE WON THE GAME EVEN THOUGH BOTH SHE AND HIM KNOW THAT
# HE WAS THE TRUE WINNER AND THAT SHE JUST COULDN'T HANDLE LOSING.
# WE GET THAT SHE IS BETTER THAN HIM AT EATING SUSHI AND JUST
# COULDNT IMAGINE HIM BEING BETTER THAN HER AT SOMETHING BECAUSE
# HE HIGHKEY ISNT FOR THE MOST PART BUT ANYWAYS HE DID END UP DOING
# A BETTER TIME THAN HER OUTSIDE AND BECAUSE OF THAT SHE WAS MAD
# OK SORRY FOR TYPING THIS ALL OUT HOPEFULLY YOU DIDNT READ ALL
# OF THIS :) OK BYE HAVE A NICE DAY HOPEFULLY YOU HAVE SOMETHING
# BEING TO DO THAN READ THIS USELESS TEXT BYE BYE BYE BYE BYE BYE. 
#
